        ...
        function L(n, o, t) {
            if (o) {
                ...
                for (i = o.length - 1; i >= 0; i--)
                    if (s = o[i],
                        e.isString(s) || (s = E(s)),
                        s && -1 === l.indexOf(s) && (!w[s] || -1 !== a.indexOf(s))) {
                        var h = -1 === r.indexOf(s);
                        if (d = g(s),
                            h && (r.push(s),
                                L(n, d.requires, t)),
                            d._runBlocks.length > 0)
                            for (c[s] = []; d._runBlocks.length > 0;)
                                c[s].push(d._runBlocks.shift());
                        e.isDefined(c[s]) && (h || t.rerun) && (f = f.concat(c[s])),
                            j(n, d._invokeQueue, s, t.reconfig),
                            j(n, d._configBlocks, s, t.reconfig),
            ...
            if (r) {
                ...
                for (a = 0,
                    ...
                    if (u = r[a],
                        ...
                        var l = $(u, o);
                        if ("invoke" !== u[1])
                            l && e.isDefined(c) && c[u[1]].apply(c, u[2]);
                        else {
                            var d = function (n) {
                                var r = t.indexOf(o + "-" + n);
                            ...
                            if (e.isFunction(u[2][0]))
                                ...
                                for (var f = 0, h = u[2][0].length; h > f; f++)
                                    e.isFunction(u[2][0][f]) && d(u[2][0][f])
                        }
                    }
            }
        }
        ...
        e.module("oc.lazyLoad").config(["$provide", function (n) {
            n.decorator("$ocLazyLoad", ["$delegate", "$q", "$window", "$interval", function (n, r, o, t) {
                ...
                return n.buildElement = function (u, c, l) {
                    ...
                    u) {
                        case "css":
                            d = o.document.createElement("link"),
                                d.type = "text/css",
                                d.rel = "stylesheet",
                    ...
                    n.load = function (o) {
                        ...
                        if (e.isArray(l))
                            return e.forEach(l, function (e) {
                                ...
                                c.promise;
                        if (e.isString(l) ? (s = a.getModuleConfig(l),
                            s || (s = {
                                files: [l]
