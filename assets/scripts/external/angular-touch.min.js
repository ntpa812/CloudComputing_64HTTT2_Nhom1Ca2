            ...
            bind: function (a, b, l) {
                ...
                a.on(k(l, "move"), function (c) {
                    if (d && h) {
                        ...
                        m = a;
                        10 > e && 10 > g || (g > e ? (d = !1,
                            b.cancel && b.cancel(c)) : (c.preventDefault(),
                                b.move && b.move(a, c)))
                    }
                });
    ...
    var t = ["$parse", "$timeout", "$rootElement", function (f, k, e) {
        ...
        return function (h, d, k) {
            ...
            d.on("touchend", function (c) {
                ...
                w && 750 > h && 12 > v && (g || (e[0].addEventListener("click", b, !0),
                    e[0].addEventListener("touchstart", l, !0),
                    g = []),
                    u = Date.now(),
                    a(g, f, m),
                    q && q.blur(),
                    n.isDefined(k.disabled) && !1 !== k.disabled || d.triggerHandler("click", [c]));
                w = !1;
                d.removeClass("ng-click-active")
            });
