...
(function (q, e) {
    ...
    function B(a, c) {
        ...
        for (b = g.firstChild; b;) {
            ...
            var d;
            if (!(d = b.firstChild) && (1 == b.nodeType && c.end(b.nodeName.toLowerCase()),
                d = b.nextSibling,
                !d))
                for (; null == d;) {
                    b = b.parentNode;
    ...
    (function (a) {
        ...
        1 === c.length ? g = c[0] : (c = a.createElement("html"),
    ...
    e.module("ngSanitize").filter("linky", ["$sanitize", function (a) {
        ...
        return function (f, h, k) {
            ...
            function q(a, b) {
                ...
                for (c in d)
                    p.push(c + '="' + d[c] + '" ');
                !e.isDefined(h) || "target" in d || p.push('target="', h, '" ');
            ...
            for (var r = e.isFunction(k) ? k : e.isObject(k) ? function () {
                ...
                t = f[0],
                    f[2] || f[4] || (t = (f[3] ? "http://" : "mailto:") + t),
                    n = f.index,
                    m(s.substr(0, n)),
                    q(t, f[0].replace(b, "")),
                    s = s.substring(n + f[0].length);
            m(s);
            return a(p.join(""))
        }
    }
