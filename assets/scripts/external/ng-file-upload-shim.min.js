...
!function () {
        ...
        a("open", function (a) {
            return function (b, d, e) {
                ...
                try {
                    ...
                    f.message.indexOf("Access is denied") > -1 && (this.__origError = f,
                        ...
                        var d = arguments[0]
                            , e = {
                                ...
                                complete: function (a, d) {
                                    a && angular.isString(a) && -1 !== a.indexOf("#2174") && (a = null),
                                        c.__completed = !0,
    ...
    window.FileReader || (window.FileReader = function () {
        ...
        var c = function (b, c) {
            ...
            , d = function (d) {
                b || (b = !0,
                    a.onloadstart && a.onloadstart(c("loadstart", d)));
                var e;
                "load" === d.type ? (a.onloadend && a.onloadend(c("loadend", d)),
                    e = c("load", d),
                    a.onload && a.onload(e),
                    a.dispatchEvent(e)) : "progress" === d.type ? (e = c("progress", d),
                        a.onprogress && a.onprogress(e),
                        a.dispatchEvent(e)) : (e = c("error", d),
