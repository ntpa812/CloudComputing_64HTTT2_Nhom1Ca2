    ...
    b.module("ngIdle", ["ngIdle.keepalive", "ngIdle.idle", "ngIdle.countdown", "ngIdle.title", "ngIdle.localStorage"]),
        b.module("ngIdle.keepalive", []).provider("Keepalive", function () {
            ...
            this.$get = ["$rootScope", "$log", "$interval", "$http", function (d, e, f, g) {
                ...
                function i() {
                    d.$broadcast("Keepalive"),
                        b.isObject(a.http) && g(a.http).then(h)["catch"](h)
                }
                var j = {
                    ping: null
                };
                return {
                    ...
                    setInterval: c,
                    start: function () {
                        return f.cancel(j.ping),
                            j.ping = f(i, 1e3 * a.interval),
                            j.ping
                    },
                    stop: function () {
                        f.cancel(j.ping)
            ...
            this.autoResume = function (b) {
                ...
                this.$get = ["$interval", "$log", "$rootScope", "$document", "Keepalive", "IdleLocalStorage", "$window", function (e, f, g, h, i, j, k) {
                    ...
                    function n() {
                        ...
                        u.idling ? (g.$broadcast(b),
                            m(),
                            a.timeout && (u.countdown = a.timeout,
                                o(),
                                u.timeout = e(o, 1e3, a.timeout, !1))) : (l(),
                                    g.$broadcast(b)),
                            e.cancel(u.idle)
                    }
                    function o() {
                        if (u.idling) {
                            if (u.countdown <= 0)
                                return void q();
                            g.$broadcast("IdleWarn", u.countdown),
                                u.countdown--
                        }
                    }
                    function p(a) {
                    ...
                    var u = {
                        ...
                        , w = {
                            ...
                            interrupt: function (b) {
                                if (u.running) {
                                    if (a.timeout && this.isExpired())
                                        return void q();
                                    p(b),
                                        (b || "idle" === a.autoResume || "notIdle" === a.autoResume && !u.idling) && this.watch(b)
                                }
                            }
                        }
                        , x = {
                    ...
                    if (h.find("html").on(a.interrupt, function (a) {
                        ...
                        for (var y = a.windowInterrupt.split(" "), z = function () {
                            ...
                            k.addEventListener ? (k.addEventListener(y[A], z, !1),
                    ...
                    return k.addEventListener ? (k.addEventListener("storage", B, !1),
                        g.$on("$destroy", function () {
        ...
        b.module("ngIdle.title", []).provider("Title", function () {
            ...
            return {
                restrict: "E",
                link: function (b, c, d) {
                    a.isEnabled() && !d.idleDisabled && (a.store(!0),
        ...
        b.module("ngIdle.localStorage", []).service("IdleStorageAccessor", ["$window", function (a) {
            ...
            function e() {
                try {
                    var b = a.get();
                    return b.setItem("ngIdleStorage", ""),
                        b.removeItem("ngIdleStorage"),
                        b
                } catch (c) {
                    return new d
                }
