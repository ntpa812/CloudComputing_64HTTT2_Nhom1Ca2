...
!function (a) {
    ...
    function d(b, c) {
        ...
        if (!e && "INPUT" === b.tagName) {
            ...
            f.setAttribute("type", d),
                e = "text" === f.type,
                //apply mask only if the type is not natively supported
                f = null
        }
        return e
    }
    ...
    function f(b, c, d) {
        ...
        f("alias", i),
            //pickup alias from data-inputmask-alias
    ...
    function h(e, f, g) {
        ...
        function o(a, b, c) {
            ...
            for (var g in f) {
                var h = parseInt(g);
                f[h] && (b || null !== f[h].match.fn) && (h <= a && (d = h),
                    h >= a && (e = h))
            }
        ...
        function q(a, b) {
            for (var c, d = a, e = o(), f = m().validPositions[e] || v(0)[0], h = void 0 !== f.alternation ? f.locator[f.alternation].toString().split(",") : [], i = 0; i < d.length && (c = d[i],
                !(c.match && (g.greedy && c.match.optionalQuantifier !== !0 || (c.match.optionality === !1 || c.match.newBlockMarker === !1) && c.match.optionalQuantifier !== !0) && (void 0 === f.alternation || f.alternation !== c.alternation || void 0 !== c.locator[f.alternation] && A(c.locator[f.alternation].toString().split(","), h))) || b === !0 && (null !== c.match.fn || /[0-9a-bA-Z]/.test(c.match.def))); i++)
                ;
            return c
        }
        function r(a, b, c) {
        ...
        function v(b, c, d) {
                    ...
                    if (void 0 !== f.matches) {
                        if (f.isGroup && l !== f) {
                            if (//when a group pass along to the quantifier
                                f = j(c.matches[a.inArray(f, c.matches) + 1], h))
                                return !0
                        } else if (f.isOptional) {
                            var t = f;
                            if (f = e(f, d, h, l)) {
                                if (i = n[n.length - 1].match,
                                    !q(i, t))
                                    return !0;
                                o = !0,
                                    //insert a stop
                            ...
                            var v, w = f, x = [], y = n.slice(), z = h.length, A = d.length > 0 ? d.shift() : -1;
                            if (A === -1 || "string" == typeof A) {
                                ...
                                for (var F = 0; F < E.length; F++) {
                                    if (B = parseInt(E[F]),
                                        ...
                                        f = j(w.matches[B] || c.matches[B], [B].concat(h), l) || f,
                                        ...
                                        for (var K = 0; K < x.length; K++) {
                                            ...
                                            if (("string" != typeof A || a.inArray(I.locator[I.alternation].toString(), E) !== -1) && (I.match.def === L.match.def || s(I, L))) {
                                                J = I.match.mask === L.match.mask,
                                                    L.locator[I.alternation].toString().indexOf(I.locator[I.alternation]) === -1 && (L.locator[I.alternation] = L.locator[I.alternation] + "," + I.locator[I.alternation],
                                                        L.alternation = I.alternation,
                                                        //we pass the alternation index => used in determineLastRequiredPosition
                                                        null == I.match.fn && (//staticCanMatchDefinition => set no alternate on match
                                                            L.na = L.na || I.locator[I.alternation].toString(),
                                    ...
                                    x = a.map(x, function (b, c) {
                                        if (isFinite(c)) {
                                            ...
                                            for (var g = 0; g < f.length; g++)
                                                d = a.inArray(f[g], E) !== -1,
                                                    d && (//rebuild the locator with valid entries
                                                        void 0 !== b.locator[e] ? (b.locator[e] += ",",
                            ...
                            for (var M = f, N = d.length > 0 ? d.shift() : 0; N < (isNaN(M.quantifier.max) ? N + 1 : M.quantifier.max) && k <= b; N++) {
                                ...
                                if (f = j(O, [N].concat(h), O)) {
                                    if (//get latest match
                                        i = n[n.length - 1].match,
                                        i.optionalQuantifier = N > M.quantifier.min - 1,
                                        q(i, O)) {
            ...
            function f(b) {
                ...
                return a.isArray(b) || (b = [b]),
                    b.length > 0 && (void 0 === b[0].alternation ? (c = q(b.slice()).locator.slice(),
            ...
            if (b > -1) {
                if (void 0 === c) {
                    for (//determine index initializer
                        var r, s = b - 1; void 0 === (r = m().validPositions[s] || m().tests[s]) && s > -1;)
                        s--;
                    void 0 !== r && s > -1 && (l = f(r),
                        p = l.join(""),
                        k = s)
        ...
        function w() {
            ...
            return void 0 === m()._buffer && (m()._buffer = i(!1, 1),
                void 0 === m().buffer && m()._buffer.slice()),
                m()._buffer
        }
        function x(a) {
            return void 0 !== m().buffer && a !== !0 || (m().buffer = i(!0, o(), !0)),
                m().buffer
        }
        function y(a, b, c) {
            var d;
            ...
            for (d = a; d < b; d++)
                n(!0),
                    //prevents clobber from the buffer
        ...
        function B(c, d, e, f, h) {
                    ...
                    if (d && (r += d),
                        ...
                        if (void 0 !== h.remove && (//remove position(s)
                            ...
                            if (e = !0,
                                ...
                                void 0 === h.pos && void 0 === h.c)
                                return h.pos = o(),
                                    !1;
                            if (v = void 0 !== h.pos ? h.pos : b,
                                v !== b)
                                //revalidate new position strict
                                return h = a.extend(h, B(v, u, !0, f)),
                                    !1
                            ...
                            v !== b))
                            //revalidate new position strict
                            return h = a.extend(h, B(v, u, !0)),
                                !1;
                        return (h === !0 || void 0 !== h.pos || void 0 !== h.c) && (j > 0 && n(!0),
                            s(v, a.extend({}, k, {
                                input: z(u, l, v)
                            }), f, i(c)) || (h = !1),
                            !1)
            ...
            function k(b, c, d) {
                ...
                for (//find last modified alternation
                    ...
                    if (i = m().validPositions[t],
                        i && void 0 !== i.alternation) {
                        if (e = t,
                            h = m().validPositions[e].alternation,
                            j.locator[i.alternation] !== i.locator[i.alternation])
                            break;
                        j = i
                    }
                if (void 0 !== h) {
                    ...
                    a.each(v(q, x ? x.locator : void 0, q - 1), function (e, i) {
                        ...
                        for (var j = 0; j < p.length; j++) {
                            ...
                            if (u < p[j] && (void 0 === i.na || a.inArray(p[j], i.na.split(",")) === -1)) {
                                ...
                                for (m().validPositions[q].locator[h] = parseInt(p[j]),
                                    //set forced decision
                                    null == i.match.fn ? (w.input !== i.match.def && (y = !0,
                                        //verify that the new definition matches the input
                                        w.generatedInput !== !0 && t.push(w.input)),
                                        x++,
                                        m().validPositions[q].generatedInput = !/[0-9a-bA-Z]/.test(i.match.def),
                                        m().validPositions[q].input = i.match.def) : m().validPositions[q].input = w.input,
                                    k = q + 1; k < o(void 0, !0) + 1; k++)
                                    l = m().validPositions[k],
                                        l && l.generatedInput !== !0 && /[0-9a-bA-Z]/.test(l.input) ? t.push(l.input) : k < b && v++,
                                        delete m().validPositions[k];
                                for (y && t[0] === i.match.def && t.shift(),
                                    n(!0),
                                    //clear getbuffer
                                    s = !0; t.length > 0;) {
                                    var A = t.shift();
                    ...
                    for (f = j = b; f <= i; f++) {
                        ...
                        if (void 0 !== r)
                            for (var s = j; s < m().maskLength && (null == r.match.fn && l[f] && (l[f].match.optionalQuantifier === !0 || l[f].match.optionality === !0) || null != r.match.fn);) {
                                ...
                                //a bit hacky but the masklength is corrected later on
                                if (m().maskLength < q && (m().maskLength = q),
                                    k)
                                    break
                            }
                        if (!k)
            ...
            function u(b) {
                ...
                var d, e;
                for (c++; c < b; c++)
                    void 0 === m().validPositions[c] && (g.jitMasking === !1 || g.jitMasking > c) && (e = v(c, r(c - 1).locator, c - 1).slice(),
                        "" === e[e.length - 1].match.def && e.pop(),
                        d = q(e),
                        d && (d.match.def === g.radixPointDefinitionSymbol || !C(c, !0) || a.inArray(g.radixPoint, x()) < c && d.match.fn && d.match.fn.test(H(c), m(), c, !1, g)) && (E = j(c, d.match.placeholder || (null == d.match.fn ? d.match.def : "" !== H(c) ? H(c) : x()[c]), !0),
                            E !== !1 && (m().validPositions[E.pos || c].generatedInput = !0)))
            }
            e = e === !0;
            ...
            void 0 !== c.begin && (//position was a position object - used to handle a delete by typing over a selection
                w = ia && !i(c) ? c.end : c.begin);
            var E = !1
                , G = a.extend(!0, {}, m().validPositions);
            if (//clone the currentPositions
                u(w),
                i(c) && (P(void 0, b.keyCode.DELETE, c),
                    w = m().p),
                w < m().maskLength && (E = j(w, d, e),
                    (!e || f === !0) && E === !1)) {
                ...
                if (!I || null !== I.match.fn || I.match.def !== d && d !== g.skipOptionalPartCharacter) {
                    if ((g.insertMode || void 0 === m().validPositions[D(w)]) && !C(w, !0)) {
                        ...
                        var K = q(J, !0);
                        K && (K = K.match.placeholder || K.match.def,
                            j(w, K, e),
                            m().validPositions[w].generatedInput = !0);
            ...
            return E === !1 && g.keepStatic && !e && h !== !0 && (E = k(w, d, e)),
                E === !0 && (E = {
                    pos: w
                }),
                a.isFunction(g.postValidation) && E !== !1 && !e && f !== !0 && (E = !!g.postValidation(x(!0), E, g) && E),
                void 0 === E.pos && (E.pos = w),
                E === !1 && (n(!0),
                    m().validPositions = a.extend(!0, {}, G)),
                E
        }
        function C(a, b) {
            var c;
            if (b ? (c = r(a).match,
                "" === c.def && (c = s(a).match)) : c = s(a).match,
                null != c.fn)
                return c.fn;
            if (b !== !0 && a > -1) {
                var d = v(a);
        ...
        function E(a, b) {
            ...
            if (d <= 0)
                return 0;
            for (; --d > 0 && (b === !0 && s(d).match.newBlockMarker !== !0 || b !== !0 && !C(d) && (c = v(d),
        ...
        function I(c, d, e, f, h, i) {
            ...
            if (n(),
                ...
                if (g.autoUnmask !== !0) {
                    ...
                    t && t.length > 0 && (k.splice(0, t.length * s.length),
                        p = D(p))
                } else
                    p = D(p);
            if (a.each(k, function (b, d) {
                if (void 0 !== d) {
                    ...
                    if (!e && a.isFunction(g.onBeforeWrite) && (q = g.onBeforeWrite(f, x(), q.forwardPosition, g),
                        q && q.refreshFromBuffer)) {
                ...
                var u = void 0
                    , v = o();
                document.activeElement === c && (h || q) && (u = K(c).begin - (i === !0 ? 1 : 0),
                    q && i !== !0 && (u < v + 1 || v === -1) && (u = g.numericInput && void 0 === q.caret ? E(q.forwardPosition) : q.forwardPosition)),
        ...
        function P(c, d, e, f) {
            function h() {
                if (g.keepStatic) {
                    ...
                    for (var b = [], d = o(-1, !0), e = a.extend(!0, {}, m().validPositions), f = m().validPositions[d]; d >= 0; d--) {
                        ...
                        if (h) {
                            if (h.generatedInput !== !0 && /[0-9a-bA-Z]/.test(h.input) && b.push(h.input),
                                delete m().validPositions[d],
                                void 0 !== h.alternation && h.locator[h.alternation] !== f.locator[h.alternation])
                                break;
                            f = h
                        }
                    }
            ...
            d === b.keyCode.BACKSPACE && (e.end - e.begin < 1 || g.insertMode === !1) ? (e.begin = E(e.begin),
                void 0 === m().validPositions[e.begin] || m().validPositions[e.begin].input !== g.groupSeparator && m().validPositions[e.begin].input !== g.radixPoint || e.begin--) : d === b.keyCode.DELETE && e.begin === e.end && (e.end = C(e.end, !0) ? e.end + 1 : D(e.end) + 1,
                ...
                f !== !0 && h();
            var j = o(e.begin, !0);
            j < e.begin ? //if (lvp === -1) resetMaskSet();
        ...
        function Q(d) {
            ...
            if (h === b.keyCode.BACKSPACE || h === b.keyCode.DELETE || l && h === b.keyCode.BACKSPACE_SAFARI || d.ctrlKey && h === b.keyCode.X && !c("cut"))
                ...
                h === b.keyCode.HOME && !d.shiftKey || h === b.keyCode.PAGE_UP ? (//Home or page_up
                    d.preventDefault(),
                    K(e, 0, d.shiftKey ? i.begin : 0, !0)) : (g.undoOnEscape && h === b.keyCode.ESCAPE || 90 === h && d.ctrlKey) && d.altKey !== !0 ? (//escape && undo && #762
                        I(e, !0, !1, da.split("")),
                        f.trigger("click")) : h !== b.keyCode.INSERT || d.shiftKey || d.ctrlKey ? g.tabThrough === !0 && h === b.keyCode.TAB ? (d.shiftKey === !0 ? (null === s(i.begin).match.fn && (i.begin = D(i.begin)),
                            i.end = E(i.begin, !0),
        ...
        function R(c, d, e, f, h) {
            ...
            if (k) {
                ...
                var q = B(o, p, f);
                if (q !== !1 && (n(!0),
                    l = void 0 !== q.caret ? q.caret : d ? q.pos + 1 : D(q.pos),
                    m().p = l),
                    e !== !1) {
                    var r = this;
        ...
        function S(b) {
            ...
            if (j === (ia ? w().reverse() : w()).slice(0, i.begin).join("") && (j = ""),
        ...
        function V(a) {
            ...
            g.showMaskOnFocus && (!g.showMaskOnHover || g.showMaskOnHover && "" === c) ? b.inputmask._valueGet() !== x().join("") && G(b, x(), D(o())) : ma === !1 && //only executed on focus without mouseenter
                K(b, D(o())),
        ...
        function W(a) {
            ...
            if (ma = !1,
                ...
                d !== b.getAttribute("placeholder") && "" !== d && (o() === -1 && d === w().join("") ? c = [] : //clearout optional tail of the mask
                    M(c),
                    G(b, c))
            }
        }
        ...
        function Z(c) {
            ...
            i.setData("text", ia ? j.reverse().join("") : j.join("")),
                ...
                // copy selected content to system clipbaord
        ...
        function $(b) {
            ...
            if (d.inputmask) {
                ...
                da !== f.join("") && setTimeout(function () {
                    ...
                    "" !== e && (g.clearMaskOnLostFocus && (o() === -1 && e === w().join("") ? f = [] : //clearout optional tail of the mask
                        M(f)),
        ...
        function ca(b) {
            //initialize the buffer and getmasklength
            if (ea = b,
                fa = a(ea),
                //show tooltip
                ...
                da = e.join(""),
                    ...
                    G(ea, e),
                    document.activeElement === ea && //position the caret when in focus
                    K(ea, D(o()))
            }
        }
        var da, ea, fa, ga, ha, ia = !1, ja = !1, //Safari 5.1.x - modal dialog fires keypress twice workaround
        ...
        return void 0 === a.fn.inputmask && (a.fn.inputmask = function (c, d) {
            ...
            if (void 0 === d && (d = {}),
                ...
                switch (c) {
                    ...
                    case "setvalue":
                        a(f).val(d),
                            f && void 0 === f.inputmask && //reactivate jquery.clone
            ...
            numeric: {
                mask: function (a) {
                    ...
                    if (0 !== a.repeat && isNaN(a.integerDigits) && (a.integerDigits = a.repeat),
                        a.repeat = 0,
                        a.groupSeparator === a.radixPoint && (//treat equal separator and radixpoint
                            "." === a.radixPoint ? a.groupSeparator = "," : "," === a.radixPoint ? a.groupSeparator = "." : a.groupSeparator = ""),
                        " " === a.groupSeparator && (//prevent conflict with default skipOptionalPartCharacter
                    ...
                    a.placeholder.length > 1 && (a.placeholder = a.placeholder.charAt(0)),
                        ...
                        //clone integer def for decimals
                        a.definitions[";"].definitionSymbol = "~",
                        a.numericInput === !0 && (//finance people input style
                            a.positionCaretOnClick = "radixFocus" === a.positionCaretOnClick ? "lvp" : a.positionCaretOnClick,
                            a.digitsOptional = !1,
                ...
                postFormat: function (c, d, e) {
                    ...
                    var h = c[d]
                        , i = c.slice();
                    h === e.groupSeparator && (i.splice(d--, 1),
                        h = i[d]),
                        //mark current pos
                        i[d] = "!";
                    var j = i.join("")
                        , k = j;
                    if (j = j.replace(new RegExp(b.escapeRegex(e.suffix) + "$"), ""),
                        j = j.replace(new RegExp("^" + b.escapeRegex(e.prefix)), ""),
                        ...
                        if (j = "" === e.radixPoint ? j : m[0],
                            h !== e.negationSymbol.front && (j = j.replace("!", "?")),
                            j.length > e.groupSize)
                    ...
                    return c[p] = h,
                        p = e.numericInput && isFinite(d) ? c.join("").length - p - 1 : p,
                        e.numericInput && (c = c.reverse(),
                            a.inArray(e.radixPoint, c) < p && c.join("").length - e.suffix.length !== p && (p -= 1)),
                    {
                        pos: p,
                        refreshFromBuffer: o,
                        buffer: c
                ...
                onBeforeWrite: function (c, d, e, f) {
                    ...
                    if (c && ("blur" === c.type || "checkval" === c.type || "keydown" === c.type)) {
                        ...
                        if (j = null !== j && 1 === j.length,
                            ...
                            isNaN(f.placeholder) && (i = i.replace(new RegExp(b.escapeRegex(f.placeholder), "g"), "")),
                            ...
                            if (null !== f.min && isFinite(f.min) && l < parseFloat(f.min) ? (k = Math.abs(f.min),
                                j = f.min < 0,
                                h = void 0) : null !== f.max && isFinite(f.max) && l > parseFloat(f.max) && (k = Math.abs(f.max),
                                    j = f.max < 0,
                                    h = void 0),
                            ...
                            if (k.toString() !== i && k.toString() + "." !== i || j)
                                return !j || 0 === k && "blur" === c.type || (i.unshift(f.negationSymbol.front),
                    ...
                    if (f.autoGroup)
                        return g = f.postFormat(d, f.numericInput ? e : e - 1, f),
                ...
                leadingZeroHandler: function (b, c, d, e, f, g) {
                    if (!e) {
                        ...
                        if (h.splice(0, f.prefix.length),
                            h.splice(h.length - f.suffix.length, f.suffix.length),
                            f.numericInput === !0) {
                            var h = h.reverse()
                                , i = h[0];
                ...
                definitions: {
                    "~": {
                        validator: function (c, d, e, f, g, h) {
                            ...
                            if (!i && (i = g.radixHandler(c, d, e, f, g),
                                !i && (i = f ? new RegExp("[0-9" + b.escapeRegex(g.groupSeparator) + "]").test(c) : new RegExp("[0-9]").test(c),
                                    i === !0 && (i = g.leadingZeroHandler(c, d, e, f, g, h),
                                        i === !0)))) {
                ...
                onBeforeMask: function (a, c) {
                    if (c.numericInput === !0 && (a = a.split("").reverse().join("")),
                        "" !== c.radixPoint && isFinite(a))
                        a = a.toString().replace(".", c.radixPoint);
                    else {
                        var d = a.match(/,/g)
                            , e = a.match(/\./g);
                        e && d ? e.length > d.length ? (a = a.replace(/\./g, ""),
                            a = a.replace(",", c.radixPoint)) : d.length > e.length ? (a = a.replace(/,/g, ""),
                                a = a.replace(".", c.radixPoint)) : //equal
                    ...
                    return c.numericInput === !0 && (a = a.split("").reverse().join("")),
                        a.toString()
                },
